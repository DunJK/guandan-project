...
parser.add_argument('--data_port', type=int, default=5002, help='Learner server port to receive training data')
...
parser.add_argument('--ckpt_save_freq', type=int, default=300, help='The number of updates between each weights saving')
