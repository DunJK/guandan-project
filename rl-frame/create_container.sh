...
for i in {3..10}
do
    docker run -itd --network=guandanNet --ip 172.15.15.$i --name guandan_actor_$i -v /Users/dupeng/Desktop/掼蛋AI玩家/guandan_mcc-main/rl-frame/log/log$i:/home/dupeng/log -v /Users/dupeng/Desktop/掼蛋AI玩家/guandan_mcc-main/rl-frame/guandan:/home/dupeng/guandan -w /home/dupeng/guandan/actor  guandan_actor:v5 /bin/bash -c "/bin/bash /home/dupeng/guandan/actor/start.sh;/bin/bash"
done
