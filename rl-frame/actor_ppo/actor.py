...
parser.add_argument('--data_port', type=int, default=6000,
                    help='Learner server port to send training data')
parser.add_argument('--param_port', type=int, default=6001,
                    help='Learner server port to subscribe model parameters')
parser.add_argument('--exp_path', type=str, default='/Users/dupeng/guandanlog',
